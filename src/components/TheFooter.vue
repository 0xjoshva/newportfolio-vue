<template>
    ...
    <div class="container">
      <div class="info">
        ...
        <div class="contact">
          ...
          >
          <a href="tel:0624597048">+27 62 459 7048</a>
        </div>
      </div>
      <div class="nav">
  ...
  <div class="right">
    <p>built by me with</p>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="1em"
      width="1em"
      viewBox="0 0 512 512"
      class="transition-all hover:text-red-400 transform hover:scale-125 hover:-translate-y-1 inline-block"
    >
      <path
